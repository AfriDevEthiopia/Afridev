        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-10 lg:gap-12 mb-8 sm:mb-10 md:mb-12 lg:mb-16">
          ...
          <div className="col-span-2 sm:col-span-2 md:col-span-2">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 mb-4 rounded-xl bg-[#14a800] hover:bg-[#14a800]/90 text-white text-sm font-medium transition-all hover:scale-105"
            >
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`w-9 h-9 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl glass flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-primary/20 transition-all ${social.name === "Upwork" ? "hover:bg-[#14a800]/20 hover:text-[#14a800]" : ""}`}
