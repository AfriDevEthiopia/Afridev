            ...
            >
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`w-9 h-9 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl glass flex items-center justify-center text-muted-foreground hover:text-foreground transition-all ${social.name === "Upwork" ? "hover:bg-[#14a800]/20 hover:text-[#14a800]" : social.name === "LinkedIn" ? "hover:bg-[#0077b5]/20 hover:text-[#0077b5]" : "hover:bg-primary/20"}`}
